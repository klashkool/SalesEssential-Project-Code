...
public class Mcs_Asset extends Salesessential_base {
	static WebDriverWait wait = new WebDriverWait(driver, 200);
	static List<HashMap<String, String>> Mcs_Asset = ExcelSheetReader.Mcs_Asset_data();
	
	public static void Create_Mcs_Assets() throws InterruptedException {
		...
		// To click on Create New Button under Assets tabs
				...
				//driver.findElement(By.xpath("//*[@id='home-pillar-asset-wrapper']/div/div[3]/app-modify-asset/div/form/div[1]/fieldset/div[1]/input")).sendKeys(Mcs_Asset.get(0).get("Title LoadFile"));
				...
				driver.findElement(By.name("arDescription")).sendKeys(Mcs_Asset.get(0).get("Description LoadFile"));
				Thread.sleep(500);
				...
				driver.findElement(By.xpath("//*[@id='home-pillar-asset-wrapper']/div/div[3]/app-modify-asset/div/form/div[1]/fieldset/div[4]/tag-input/div/div/tag-input-form/form/input"))
						.sendKeys(Mcs_Asset.get(0).get("Keywords LoadFile"));
				driver.findElement(By.xpath("//*[@id='home-pillar-asset-wrapper']/div/div[3]/app-modify-asset/div/form/div[1]/fieldset/div[4]/tag-input/div/div/tag-input-form/form/input"))
						.sendKeys(Keys.ENTER);
				
				// OWNER EMAIL
				
				driver.findElement(By.name("arOwnerEMail")).sendKeys(Mcs_Asset.get(0).get("Owner Email"));
				...
				catgry.selectByVisibleText(Mcs_Asset.get(0).get("Content Category"));
				
				// Client Facing 
				
				String[] ClientFacing = Mcs_Asset.get(0).get("Client Facing LoadFile").split("/", 0);
				...
				String[] Content_Flavour = Mcs_Asset.get(0).get("Content Flavour").split("/", 0);
...
//				Assert.assertEquals(Content_FormatList, SelectedContent_FormatList);
				...
				String[] Audience = Mcs_Asset.get(0).get("Audience LoadFile").split("/", 0);
				...
				// Seller Role
				String[] Sellerrole_Asset = Mcs_Asset.get(0).get("SellerRole LoadFile").split("/", 0);
				...
				String[] SalesStage1 = Mcs_Asset.get(0).get("SalesStage LoadFile").split("/", 0);
				...
				// Buyers Journey
				String[] BuyJour = Mcs_Asset.get(0).get("Buyersjourney LoadFile").split("/", 0);
				...
				// Geography
				String[] Geo = Mcs_Asset.get(0).get("Geography LoadFile").split("/", 0);
				...
				// Industry
				String[] Industry = Mcs_Asset.get(0).get("Industry LoadFile").split("/", 0);
...
//				
				String[] SL = Mcs_Asset.get(0).get("Service Lines").split("/", 0);
				List<String> SLList = Arrays.asList(SL);
				System.out.println(SLList);

				WebElement SL_view = driver
						.findElement(By.xpath("//*[@id='home-pillar-asset-wrapper']/div/div[3]/app-modify-asset/div/form/div[1]/fieldset/div[19]/select"));
