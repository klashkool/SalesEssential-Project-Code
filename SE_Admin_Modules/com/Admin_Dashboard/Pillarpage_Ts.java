...
public class Pillarpage_Ts extends Salesessential_base {
	static WebDriverWait wait = new WebDriverWait(driver, 100);

	public static void Click_TraditionalServices() throws InterruptedException {
       ...
       Thread.sleep(5000);
		...
		Thread.sleep(2000);
		WebElement Ts_Click = driver.findElement(By.linkText("Traditional Services"));
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", Ts_Click);
		Thread.sleep(5000);
		driver.findElement(By.linkText("Traditional Services")).click();
